...
def preprocess_txt_to_dict(textfile_name):
    ...
    models = [["dice-research__lola_v1","lola"],["FacebookAI__xlm-roberta-large", "xlmr-l"],["facebook/xlm-roberta-xl", "xlmr-xl"],["google__mt5-large", "mt5-l"],["google__mt5-xl", "mt5-xl"],["facebook__m2m100_1.2B", "m2m"],["ai-forever__mGPT", "mgpt"],["bigscience__bloom-7b1", "bloom7b1"],["bigscience__bloom-1b1", "bloom1b1"],["bigscience__bloom-1b7", "bloom1b7"],["facebook__mbart-large-50", "mbart"],["Salesforce__xgen-7b-8k-base", "xgen"],["meta-llama__Llama-2-7b", "llama2"],["HuggingFaceH4__zephyr-7b-beta", "zephyr"],["Unbabel__TowerBase-7B-v0.1", "towerbase"],["SeaLLMs__SeaLLM-7B-v2", "seallm-7b-v2"],["SeaLLMs__SeaLLM-7B-v2.5", "seallm-7b-v2_5"],["SeaLLMs__SeaLLMs-v3-1.5B-Chat", "seallm-1_5b-v3"],["Henrychur__MMedLM2-1_8B", "mmedlm"],["mistralai__Mixtral-8x7B-v0.1", "mixtral"],["tiiuae__falcon-7b", "falcon"],["MediaTek-Research__Breeze-7B-Base-v1_0", "breeze"],["cis-lmu__glot500-base", "glot500"]]
