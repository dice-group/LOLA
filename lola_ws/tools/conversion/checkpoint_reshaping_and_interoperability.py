...
megatron_to_transformers = {
    ...
    "mlp.deepspeed_moe.gate.wg" : ".moe.gate.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.0.dense_h_to_4h" : ".moe.experts.0.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.0.dense_4h_to_h" : ".moe.experts.0.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.1.dense_h_to_4h" : ".moe.experts.1.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.1.dense_4h_to_h" : ".moe.experts.1.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.2.dense_h_to_4h" : ".moe.experts.2.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.2.dense_4h_to_h" : ".moe.experts.2.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.3.dense_h_to_4h" : ".moe.experts.3.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.3.dense_4h_to_h" : ".moe.experts.3.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.4.dense_h_to_4h" : ".moe.experts.4.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.4.dense_4h_to_h" : ".moe.experts.4.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.5.dense_h_to_4h" : ".moe.experts.5.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.5.dense_4h_to_h" : ".moe.experts.5.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.6.dense_h_to_4h" : ".moe.experts.6.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.6.dense_4h_to_h" : ".moe.experts.6.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.7.dense_h_to_4h" : ".moe.experts.7.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.7.dense_4h_to_h" : ".moe.experts.7.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.8.dense_h_to_4h" : ".moe.experts.8.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.8.dense_4h_to_h" : ".moe.experts.8.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.9.dense_h_to_4h" : ".moe.experts.9.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.9.dense_4h_to_h" : ".moe.experts.9.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.10.dense_h_to_4h" : ".moe.experts.10.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.10.dense_4h_to_h" : ".moe.experts.10.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.11.dense_h_to_4h" : ".moe.experts.11.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.11.dense_4h_to_h" : ".moe.experts.11.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.12.dense_h_to_4h" : ".moe.experts.12.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.12.dense_4h_to_h" : ".moe.experts.12.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.13.dense_h_to_4h" : ".moe.experts.13.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.13.dense_4h_to_h" : ".moe.experts.13.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.14.dense_h_to_4h" : ".moe.experts.14.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.14.dense_4h_to_h" : ".moe.experts.14.c_proj.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.15.dense_h_to_4h" : ".moe.experts.15.c_fc.",
    "mlp.deepspeed_moe.experts.deepspeed_experts.15.dense_4h_to_h" : ".moe.experts.15.c_proj."
}
...
def get_element_from_dict_by_path(d, path):
    ...
    while len(path) > 0:
        ...
        if k in d:
            ...
            # try to read keys which contain the rest of the path concatenated with dots to a single string
            full = '.'.join(path)
            if full in d:
                return d[full]
            else:
...
def convert_checkpoint_from_megatron_to_transformers(args):
    ...
    for pp_rank in range(pp_size):
        ...
        for key, val in get_element_from_dict_by_path(tp_state_dicts[0], path).items():
            ...
            # Commenting tensor_parallel logic for LOLA
            # fail if tensor parallelism is involved
            assert tp_size ==1 # remove if uncommenting logic below
            params = val.to(dtype) # remove if uncommenting logic below
            ...
            # Transpose the weights.
                ...
                if out_name != ".moe.gate.":
                    output_params = output_params.transpose(0, 1)
                output_state_dict[layer_name + out_name + "weight"] = output_params
...
def convert_checkpoint_from_transformers_to_megatron(args):
    ...
    config = LOLAConfig.from_pretrained(args.load_path)
